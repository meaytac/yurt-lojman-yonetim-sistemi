...
namespace yurt_lojman_yonetim_sistemi.Migrations
{
    ...
    [Migration("20260902002141_AddBlockUniqueAndAnnouncementTarget")]
    partial class AddBlockUniqueAndAnnouncementTarget
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("yurt_lojman_yonetim_sistemi.Models.Announcement", b =>
                {
                    ...
                    b.Property<string>("TargetFacilityName")
                        .IsRequired()
                        .HasMaxLength(180)
                        .HasColumnType("TEXT");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            TargetFacilityName = "Tüm Tesisler",
                            TargetRole = "All",
            ...
            modelBuilder.Entity("yurt_lojman_yonetim_sistemi.Models.Building", b =>
                {
                    ...
                    b.HasIndex("DormitoryId", "BlockName")
                        .IsUnique();

                    b.HasIndex("HousingUnitId", "BlockName")
                        .IsUnique();
